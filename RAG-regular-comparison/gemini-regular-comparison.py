...
def analyze():
    ...
    intro_prompt = (
        ...
        "The similarities and differences should be presented with bullet points, prioritized by "
        "importance/significance. Highlight the main parts in the important bullets and address specific pages "
        "and paragraphs in the documents accordingly. Also point out if a document has specific term or section "
        "that the other document doesn’t have.\n"
        "Similarities:\n"
